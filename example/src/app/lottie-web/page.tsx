  ...
  return (
    <div style={{ padding: "2rem", maxWidth: "1200px", margin: "0 auto" }}>
      ...
      <p style={{ marginBottom: "2rem", fontSize: "1.1rem" }}>
        This page demonstrates direct usage of lottie-web library. Use this as a
        baseline to understand the underlying behavior and properties.
      </p>
...
animation.goToAndPlay(frame, isFrame)`}
      ...
      >
        ...
        <ul>
          <li>
            <strong>Performance:</strong> Monitor frame rate and smoothness
          </li>
          <li>
            <strong>Memory Usage:</strong> Check browser dev tools
          </li>
          <li>
            <strong>API Surface:</strong> Note the available properties and
            methods
          </li>
          <li>
            <strong>Events:</strong> See console for animation events
          </li>
        </ul>
      </div>
    </div>
