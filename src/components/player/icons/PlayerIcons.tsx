...
export const DirectionIcon: FC<IconProps> = ({ size = 16, color = "currentColor", className }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    <path
      d="M9 9h6v6H9V9zm-2 0V7h2v2H7zm0 2v2h2v-2H7zm2 2v2h2v-2H9zm2 0h2v2h-2v-2zm2 0v-2h2v2h-2zm0-2V9h2v2h-2zm0-2V7h2v2h-2z"
      fill={color}
    />
    <path
      d="M17 7h2v2h-2V7zm0 2v2h2V9h-2zm-2 4h2v2h-2v-2zm-2 2h2v2h-2v-2z"
      fill={color}
    />
  </svg>
);
...
export const MoreIcon: FC<IconProps> = ({ size = 16, color = "currentColor", className }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// Direction-specific icons for better UX
...
// Speed indicators for better UX
export const SpeedSlowIcon: FC<IconProps> = ({ size = 16, color = "currentColor", className }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const SpeedFastIcon: FC<IconProps> = ({ size = 16, color = "currentColor", className }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
